...
warray_1_l4= np.empty((0,9), dtype=float)
...
for i in range(50):
    ...
    weight_l2 = model.layers[2].get_weights()[0]
    warray_1_l2 = (np.transpose(weight_l2.reshape((9,32*64))), warray_1_l2)
    weight_l3 = model.layers[4].get_weights()[0]
    warray_1_l3 = (np.transpose(weight_l3.reshape((9,32*64))), warray_1_l3)
    weight_l4 = model.layers[6].get_weights()[0]
    warray_1_l4 = (np.transpose(weight_l4.reshape((9,32*64))), warray_1_l4)
    ...
    with open("Results/CNNweights_1_l2.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l2.reshape((9,32*64))), delimiter=",")
    with open("Results/CNNweights_1_l3.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l3.reshape((9,32*64))), delimiter=",")
    with open("Results/CNNweights_1_l4.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l4.reshape((9,32*64))), delimiter=",")
    ...
    with open("Results/CNNweights_2_l2.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l2.reshape((9,32*64))), delimiter=",")
    with open("Results/CNNweights_2_l3.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l3.reshape((9,32*64))), delimiter=",")
    with open("Results/CNNweights_2_l4.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l4.reshape((9,32*64))), delimiter=",")
    ...
    with open("Results/CNNweights_3.csv", "ab") as f:
      np.savetxt(f, w2, delimiter=",")
    with open("Results/CNNweights_3_l2.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l2.reshape((9,32*64))), delimiter=",")
    with open("Results/CNNweights_3_l3.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l3.reshape((9,32*64))), delimiter=",")
    with open("Results/CNNweights_3_l4.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l4.reshape((9,32*64))), delimiter=",")
    ...
    with open("Results/CNNweights_4_l2.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l2.reshape((9,32*64))), delimiter=",")
    with open("Results/CNNweights_4_l3.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l3.reshape((9,32*64))), delimiter=",")
    with open("Results/CNNweights_4_l4.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l4.reshape((9,32*64))), delimiter=",")
    ...
    with open("Results/CNNweights_5_l2.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l2.reshape((9,32*64))), delimiter=",")
    with open("Results/CNNweights_5_l3.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l3.reshape((9,32*64))), delimiter=",")
    with open("Results/CNNweights_5_l4.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l4.reshape((9,32*64))), delimiter=",")
    ...
    with open("Results/CNNweights_10_l2.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l2.reshape((9,32*64))), delimiter=",")
    with open("Results/CNNweights_10_l3.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l3.reshape((9,32*64))), delimiter=",")
    with open("Results/CNNweights_10_l4.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l4.reshape((9,32*64))), delimiter=",")
    ...
    with open("Results/CNNweights_15_l2.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l2.reshape((9,32*64))), delimiter=",")
    with open("Results/CNNweights_15_l3.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l3.reshape((9,32*64))), delimiter=",")
    with open("Results/CNNweights_15_l4.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l4.reshape((9,32*64))), delimiter=",")
    ...
    with open("Results/CNNweights_20_l2.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l2.reshape((9,32*64))), delimiter=",")
    with open("Results/CNNweights_20_l3.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l3.reshape((9,32*64))), delimiter=",")
    with open("Results/CNNweights_20_l4.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l4.reshape((9,32*64))), delimiter=",")
    ...
    with open("Results/CNNweights_40_l2.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l2.reshape((9,32*64))), delimiter=",")
    with open("Results/CNNweights_40_l3.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l3.reshape((9,32*64))), delimiter=",")
    with open("Results/CNNweights_40_l4.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l4.reshape((9,32*64))), delimiter=",")
    ...
    with open("Results/CNNweights_60_l2.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l2.reshape((9,32*64))), delimiter=",")
    with open("Results/CNNweights_60_l3.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l3.reshape((9,32*64))), delimiter=",")
    with open("Results/CNNweights_60_l4.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l4.reshape((9,32*64))), delimiter=",")
    ...
    with open("Results/CNNweights_100_l2.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l2.reshape((9,32*64))), delimiter=",")
    with open("Results/CNNweights_100_l3.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l3.reshape((9,32*64))), delimiter=",")
    with open("Results/CNNweights_100_l4.csv", "ab") as f:
      np.savetxt(f, np.transpose(weight_l4.reshape((9,32*64))), delimiter=",")
